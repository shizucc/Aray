      ...
      Container(
        ...
        child: Column(
          children: [
            Row(
              children: [
                Text("New", style: TextStyle(color: Colors.black.withOpacity(0.5), fontSize: 20),)
              ],
            ),
            Row(
              children: [
                      ...
                      Container(
                        ...
                        child:
                            Column(
                              mainAxisAlignment: MainAxisAlignment.end,
                              children: [
                                Text(style: TextStyle(fontSize: 9, color: Colors.black.withOpacity(0.5)),
                                "12.21"),
                                Text(style: TextStyle(fontSize: 9, color: Colors.black.withOpacity(0.5)),
                                "12-31-23"),
                                ],
            ...
            Row(
              children: [
                Text("All", style: TextStyle(color: Colors.black.withOpacity(0.5), fontSize: 20),),
              ],
            ),
            Row(
              children: [
